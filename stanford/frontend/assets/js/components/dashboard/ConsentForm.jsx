...
export class ConsentForm extends React.Component {
  ...
  render() {
    return (
      ...
      evaluate the effectiveness of this online educational program. As part of registering for
      this game, you agree to allow your participation and performance to be part of a
      research study. Your contact information, registration and performance will not be
      available to your employers.
			</p> 

			<p>
			<b>RISKS AND BENEFITS: </b> There are no risks to participate in this study. The benefit of
      participating in this study is that you will learn important concepts of emergency care
      through examination questions. Your responses are confidential. Your decision whether
      or not to participate in this study will not affect your employment. We cannot and do not
      ...
      The results of this research study may be presented at scientific or professional meetings or published in scientific journals.  Identifiers might be removed from identifiable private information and, after such removal, the information could be used for future research studies or distributed to another investigator for future research studies without additional informed consent from you. 
			</p>
			...
			<p>
			<b>CONSENT: </b>
      By continuing clicking the “next” button below, you agree to participate in this study and attest 
      that you have read and understand the above information.
			</p>

			<p>
			<b>INDEPENDENT CONTACT: </b>
      If you are not satisfied with how this study is being conducted, or if you have any concerns, complaints, 
      or general questions about the research or your rights as a participant, please contact the 
      Stanford Institutional Review Board (IRB) to speak to someone independent of the research team at 650-723-5244. 
      You can also write to the Stanford IRB, Stanford University, 3000 El Camino Real, Five Palo Alto Square, 4th Floor, 
      Palo Alto, CA 94306.
			</p>
