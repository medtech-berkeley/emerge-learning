...
from .models import Question, Quiz, QuizUserData, QuestionUserData, Answer, Student, Tag
...
class QuizTestCase(TestCase):
    def setUp(self):
        cat1 = Quiz.objects.create(name="cat1", start=timezone.now(),
                                       end=timezone.now(), is_challenge=False)

        c1_q1 = Question.objects.create(text="c1_q1", quiz=cat1)
        ...
        c1_q2 = Question.objects.create(text="c1_q2", quiz=cat1)
        ...
        c1_q3 = Question.objects.create(text="c1_q3", quiz=cat1)
        ...
        cat2 = Quiz.objects.create(name="cat2", start=timezone.now(),
                                       end=timezone.now(), is_challenge=False)

        c2_q1 = Question.objects.create(text="c2_q1", quiz=cat2)
        ...
        c2_q2 = Question.objects.create(text="c2_q2", quiz=cat2)
        ...
        c2_q3 = Question.objects.create(text="c2_q3", quiz=cat2)
        ...
        cat3 = Quiz.objects.create(name="cat3", start=timezone.now(),
                                       end=timezone.now(), is_challenge=False)

        c3_q1 = Question.objects.create(text="c3_q1", quiz=cat3)
        ...
        c3_q2 = Question.objects.create(text="c3_q2", quiz=cat3)
        ...
        cat4 = Quiz.objects.create(name="cat4", start=timezone.now(),
                                       end=timezone.now(), is_challenge=False)
        # cat4.tags.add(Tag.objects.create(text="Respiratory"))
        cat4.difficulty = Quiz.INTERMEDIATE
        cat4.save()

        c4_q1 = Question.objects.create(text="c4_q1", quiz=cat4)
        ...
        c4_q2 = Question.objects.create(text="c4_q2", quiz=cat4)
        ...
        cat5 = Quiz.objects.create(name="cat5", start=timezone.now(),
                                       end=timezone.now(), is_challenge=True)
        # cat5.tags.add(Tag.objects.create(text="Circulation"))
        cat5.difficulty = Quiz.ADVANCED
        cat5.save()

        c5_q1 = Question.objects.create(text="c5_q1", quiz=cat5)
        ...
        c5_q2 = Question.objects.create(text="c5_q2", quiz=cat5)
    ...
    def test_get_question_basic(self):
        response = self.client.get("/quiz/question", {'quiz': self.categories[0].id})
        self.assertEqual(response.status_code, 200)
        question = response.json()
        self.assertEqual(question['quiz'], self.categories[0].id)
    ...
    def test_get_question_multiple_categories(self):
        ...
        response2 = self.client.get("/quiz/question", {'quiz': self.categories[1].id})
        self.assertEqual(response2.status_code, 200)
        question2 = response2.json()
        self.assertEqual(question2['quiz'], self.categories[1].id)
        self.assertNotEqual(question, question2)

        response3 = self.client.get("/quiz/question", {'quiz': self.categories[2].id})
        self.assertEqual(response3.status_code, 200)
        question3 = response3.json()
        self.assertEqual(question3['quiz'], self.categories[2].id)
    ...
    def test_answer_multiple_categories(self):
        ...
        response = self.client.get("/quiz/question", {'quiz': self.categories[1].id})
        question_id = response.json()['id']
        question = Question.objects.get(id=question_id)
        answer = question.answers.filter(is_correct=True).first()
        ...
        response2 = self.client.get("/quiz/question", {'quiz': self.categories[2].id})
    ...
    def test_answer_late(self):
        ...
        question_id = response.json()['id']
        question = Question.objects.get(id=question_id)
        quiz_data = QuizUserData.objects.get(quiz=question.quiz, student=self.student)
    ...
    def test_answer_forgotten(self):
        response = self.client.get("/quiz/question", {'quiz': self.categories[0].id})  # user never submits an answer
    ...
    def test_stats_question_total_multi_user(self):
        ...
        for i, client in enumerate(clients):
            response = client.get("/quiz/question", {'quiz': self.categories[0].id})
            question_id = response.json()['id']
            question = Question.objects.get(id=question_id)
            answer = question.answers.filter(is_correct=True).first()
    ...
    def test_stats_quiz_single_user(self):
        ...
        stats = get_stats_quiz(quiz=question.quiz)
    ...
    def test_get_completed_answers(self):
        ...
        response = self.client.get("/quiz/results", {'quiz': self.categories[0].id})
    ...
    def test_get_completed_answers_fail(self):
        # start a quiz
        self.client.get("/quiz/question", {'quiz': self.categories[0].id})
        # try to get answers
        response = self.client.get("/quiz/results", {'quiz': self.categories[0].id})
    ...
    def test_get_stats_student(self):
        response = self.client.get("/quiz/question", {'quiz': self.categories[3].id})
        question_id = response.json()['id']
        question = Question.objects.get(id=question_id)
        answer = question.answers.filter(is_correct=True).first()
        ...
        response = self.client.get("/quiz/question", {'quiz': self.categories[4].id})
        question_id = response.json()['id']
        question = Question.objects.get(id=question_id)
        answer = question.answers.filter(is_correct=True).first()
