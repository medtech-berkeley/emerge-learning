...
def run():
	...
	circulation_quiz = Quiz.objects.create(name="Circulation", start=datetime.now(), end=datetime(2020,9,16), is_challenge=True)
	ems_knowledge_quiz = Quiz.objects.create(name="EMS Knowledge", start=datetime.now(), end=datetime(2020,9,16), is_challenge=False)
	
	circ_q1 = Question.objects.create(text="In an unresponsive and pulseless adult, how many chest compressions should be performed per minute during CPR?", quiz=circulation_quiz, created=datetime.now())
	...
	circ_q2 = Question.objects.create(text="For which of the following patients on a cardiac monitor would you call the ERCP immediately to report an abnormality?", quiz=circulation_quiz, created=datetime.now())
	...
	circ_q4 = Question.objects.create(text="You arrive at the scene of a 22-year-old pregnant female who has been vomiting for 3 days and is unable to eat.  She appears very dehydrated. Where on her body should you begin searching for an IV placement site?", quiz=circulation_quiz, created=datetime.now())
	...
	ems_q1 = Question.objects.create(text="Which of the following is NOT the primary responsibility of an EMT?", quiz=ems_knowledge_quiz, created=datetime.now(), max_time=timedelta(days=1, hours=10))
	...
	ems_q3 = Question.objects.create(text="How often should you run through the ambulance checklist to ensure your ambulance is fully stocked?", quiz=ems_knowledge_quiz, created=datetime.now())
