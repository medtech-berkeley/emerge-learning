...
def run():
	...
	student = Student.objects.create(user=user, location="Berkeley")
	...
	circ_q1 = Question.objects.create(text="In an unresponsive and pulseless adult, how many chest compressions should be performed per minute during CPR?", category=circulation_category, created=datetime.now(), max_time=timedelta(days=1, hours=10))
	...
	circ_q2 = Question.objects.create(text="For which of the following patients on a cardiac monitor would you call the ERCP immediately to report an abnormality?", category=circulation_category, created=datetime.now(), max_time=timedelta(days=1, hours=10))
	...
	circ_q4 = Question.objects.create(text="You arrive at the scene of a 22-year-old pregnant female who has been vomiting for 3 days and is unable to eat.  She appears very dehydrated. Where on her body should you begin searching for an IV placement site?", category=circulation_category, created=datetime.now(), max_time=timedelta(days=1, hours=10))
	...
	ems_q3 = Question.objects.create(text="How often should you run through the ambulance checklist to ensure your ambulance is fully stocked?", category=ems_knowledge_category, created=datetime.now(), max_time=timedelta(days=1, hours=10))
